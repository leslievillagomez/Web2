...
if(textoCompleto===""){
    alert("Debes ingresar el texto para generar el QR");
}
...
//TAREA TERMINAR GATO Y TERMINAR ESTA TAREA Q NO SE REPITA EL CODIGO QR Y QUEDE BONITO
//SE PUEDE DESHABILITAR EL BOTON